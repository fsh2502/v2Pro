...
!function(e, t, r, a, o) {
    ...
    "5lTcX": [function(e, t, r) {
        ...
        class G extends c.default {
            constructor(e, t) {
                ...
                this.isRotate = !1,
                this.isDestroy = !1,
                this.template = new g.default(this),
                this.events = new M.default(this),
                this.storage = new W.default(this),
                this.icons = new q.default(this),
                this.i18n = new y.default(this),
                this.notice = new L.default(this),
                this.player = new x.default(this),
                this.layers = new z.default(this),
                this.controls = new j.default(this),
                this.contextmenu = new C.default(this),
                this.subtitle = new $.default(this),
                this.info = new I.default(this),
                this.loading = new R.default(this),
                this.hotkey = new H.default(this),
                this.mask = new P.default(this),
                this.setting = new N.default(this),
                this.plugins = new K.default(this),
        ...
        G.NOTICE_TIME = 2e3,
        G.SETTING_WIDTH = 250,
        G.SETTING_ITEM_WIDTH = 200,
        G.SETTING_ITEM_HEIGHT = 35,
        G.RESIZE_TIME = 200,
        G.SCROLL_TIME = 200,
        G.SCROLL_GAP = 50,
        G.AUTO_PLAYBACK_MAX = 10,
        G.AUTO_PLAYBACK_MIN = 5,
        G.AUTO_PLAYBACK_TIMEOUT = 3e3,
        G.RECONNECT_TIME_MAX = 5,
        G.RECONNECT_SLEEP_TIME = 1e3,
        G.CONTROL_HIDE_TIME = 3e3,
        G.DBCLICK_TIME = 300,
        G.DBCLICK_FULLSCREEN = !0,
        G.MOBILE_DBCLICK_PLAY = !0,
        G.MOBILE_CLICK_PLAY = !1,
        G.AUTO_ORIENTATION_TIME = 200,
        G.INFO_LOOP_TIME = 1e3,
        G.FAST_FORWARD_VALUE = 3,
        G.FAST_FORWARD_TIME = 1e3,
        G.TOUCH_MOVE_RATIO = .5,
        G.VOLUME_STEP = .1,
        G.SEEK_STEP = 5,
        G.PLAYBACK_RATE = [.5, .75, 1, 1.25, 1.5, 2],
        G.ASPECT_RATIO = ["default", "4:3", "16:9"],
        G.FLIP = ["normal", "horizontal", "vertical"],
        G.FULLSCREEN_WEB_IN_BODY = !1,
        G.LOG_VERSION = !0,
        G.USE_RAF = !1,
        p.isBrowser && (window.Artplayer = G,
        p.setStyleText("artplayer-style", i.default),
        setTimeout( () => {
        ...
        a = function() {
            ...
            var t = Object.prototype.toString
              , r = function(r) {
                ...
                if ("symbol" === o)
                    return "symbol";
                if ("function" === o)
                    return "GeneratorFunction" === a(r) ? "generatorfunction" : "function";
                if (Array.isArray ? Array.isArray(r) : r instanceof Array)
                    return "array";
                if (r.constructor && "function" == typeof r.constructor.isBuffer && r.constructor.isBuffer(r))
                    return "buffer";
                if (function(e) {
                    try {
                    ...
                    return "arguments";
                if (r instanceof Date || "function" == typeof r.toDateString && "function" == typeof r.getDate && "function" == typeof r.setDate)
                    return "date";
                if (r instanceof Error || "string" == typeof r.message && r.constructor && "number" == typeof r.constructor.stackTraceLimit)
                    return "error";
                if (r instanceof RegExp || "string" == typeof r.flags && "boolean" == typeof r.ignoreCase && "boolean" == typeof r.multiline && "boolean" == typeof r.global)
                    return "regexp";
                switch (a(r)) {
                case "Symbol":
                    return "symbol";
                ...
                if ("function" == typeof r.throw && "function" == typeof r.return && "function" == typeof r.next)
                    return "generator";
                switch (o = t.call(r)) {
                case "[object Object]":
                    return "object";
            ...
            function o(e, t) {
                ...
                function(e, t, a) {
                    ...
                    if ("object" === s) {
                        if ("object" !== l)
                            throw Error("[Type Error]: '".concat(a.join("."), "' require 'object' type, but got '").concat(l, "'"));
                    ...
                    if ("array" === s) {
                        if ("array" !== l)
                            throw Error("[Type Error]: '".concat(a.join("."), "' require 'array' type, but got '").concat(l, "'"));
            ...
            function i(e, t, a) {
                if ("string" === r(t)) {
                    ...
                    !(-1 < t.indexOf("|") ? t.split("|").map(function(e) {
                        ...
                        throw Error("[Type Error]: '".concat(a.join("."), "' require '").concat(t, "' type, but got '").concat(o, "'"))
                }
            }
            function n(e, t, a) {
                if ("function" === r(t)) {
    ...
    "66mFZ": [function(e, t, r) {
        ...
        r.default = class {
            ...
            off(e, t) {
                ...
                return o.length ? r[e] = o : delete r[e],
                this
            }
        }
    }
    ...
    bSNiV: [function(e, t, r) {
        ...
        a.export(r, "supportsFlex", () => C),
        a.export(r, "getRect", () => S),
        a.export(r, "loadImg", () => I);
        ...
        function v(e, t, r="top") {
            o.isMobile || (e.setAttribute("aria-label", t),
            s(e, "hint--rounded"),
            s(e, `hint--${r}`))
        }
        function y(e, t=0) {
        ...
        function k(e, t) {
            ...
            r || ((r = document.createElement("style")).id = e,
    ...
    "6ZTr6": [function(e, t, r) {
        ...
        a.export(r, "isSafari", () => i),
        a.export(r, "isWechat", () => n),
        a.export(r, "isIE", () => s),
    ...
    inzwq: [function(e, t, r) {
        ...
        a.export(r, "vttToBlob", () => i),
        a.export(r, "assToVtt", () => n)
    }
    , {
        "@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
    }],
    "6b7Ip": [function(e, t, r) {
        ...
        a.defineInteropFlag(r),
        a.export(r, "getExt", () => function e(t) {
    ...
    "5NSdr": [function(e, t, r) {
        ...
        a.export(r, "has", () => n),
        a.export(r, "get", () => s),
        a.export(r, "mergeDeep", () => function e(...t) {
    ...
    epmNy: [function(e, t, r) {
        ...
        a.defineInteropFlag(r),
        a.export(r, "sleep", () => o),
        a.export(r, "debounce", () => i),
        a.export(r, "throttle", () => n)
    }
    , {
        "@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
    }],
    gapRl: [function(e, t, r) {
        ...
        a.defineInteropFlag(r),
        a.export(r, "clamp", () => o),
        a.export(r, "capitalize", () => i),
        a.export(r, "secondToTime", () => n),
        a.export(r, "escape", () => s),
        a.export(r, "unescape", () => l)
    }
    , {
        "@parcel/transformer-js/src/esmodule-helpers.js": "9pCYc"
    }],
    AKEiO: [function(e, t, r) {
        ...
        function u(e, t, r) {
            return (0,
            o.errorHandle)(t === s || t === l || e instanceof Element, `${r.join(".")} require '${s}' or 'Element' type`)
        }
        let d = {
            html: u,
            disable: `?${n}`,
        ...
        r.default = {
            ...
            controls: [{
                ...
                position: (e, t, r) => {
                    ...
                    return (0,
                    o.errorHandle)(a.includes(e), `${r.join(".")} only accept ${a.toString()} as parameters`)
                }
            }],
            quality: [{
                default: `?${n}`,
    ...
    X13Zf: [function(e, t, r) {
        ...
        class o {
            constructor(e) {
                ...
                a.query)(t.container),
                (0,
                a.errorHandle)(this.$container, `No container element found by ${t.container}`)),
                (0,
                a.errorHandle)((0,
                a.supportsFlex)(), "The current browser does not support flex layout");
                ...
                (0,
                a.errorHandle)(r.instances.every(e => e.template.$container !== this.$container), "Cannot mount multiple instances on the same dom element"),
            ...
            query(e) {
                return (0,
                a.query)(e, this.$container)
            }
            init() {
                let {option: e} = this.art;
                if (e.useSSR || (this.$container.innerHTML = o.html),
                ...
                e.proxy) {
                    ...
                    (0,
                    a.errorHandle)(t instanceof HTMLVideoElement || t instanceof HTMLCanvasElement, "Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'"),
                    (0,
                    a.replaceElement)(t, this.$video),
            ...
            o.def)(e, "url", {
                ...
                async set(a) {
                    if (a) {
                        ...
                        o.sleep)(),
                        e.loading.show = !0,
                        s.call(e, r, a, e)) : (URL.revokeObjectURL(i),
                        r.src = a),
                        i !== e.url && (e.option.url = a,
                        e.isReady && i && e.once("video:canplay", () => {
                            e.emit("restart", a)
                        }
                        ))
                    } else
    ...
    fOJuP: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {i18n: t, notice: r, option: a, constructor: {instances: i}, template: {$video: n}} = e;
            (0,
            o.def)(e, "play", {
    ...
    "6eyuR": [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {template: {$video: t}, i18n: r, notice: a, storage: i} = e;
            (0,
            o.def)(e, "volume", {
                get: () => t.volume || 0,
                set: e => {
                    t.volume = (0,
                    o.clamp)(e, 0, 1),
                    a.show = `${r.get("Volume")}: ${parseInt(100 * t.volume, 10)}`,
                    0 !== t.volume && i.set("volume", t.volume)
                }
            }),
            (0,
            o.def)(e, "muted", {
    ...
    faaWv: [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "currentTime", {
                get: () => t.currentTime || 0,
                set: r => {
                    Number.isNaN(r = parseFloat(r)) || (t.currentTime = (0,
    ...
    keKwh: [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "playbackRate", {
                get: () => t.playbackRate,
                set(o) {
                    o ? o !== t.playbackRate && (t.playbackRate = o,
                    a.show = `${r.get("Rate")}: ${1 === o ? r.get("Normal") : `${o}x`}`) : e.playbackRate = 1
                }
            })
        }
    }
    ...
    jihET: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {i18n: t, notice: r, template: {$video: a, $player: i}} = e;
            (0,
            o.def)(e, "aspectRatio", {
                ...
                set(n) {
                    ...
                    "default" === n)
                        (0,
                        o.setStyle)(a, "width", null),
                        (0,
                        o.setStyle)(a, "height", null),
                        (0,
                        o.setStyle)(a, "margin", null),
                        delete i.dataset.aspectRatio;
                    else {
                        let e = n.split(":").map(Number)
                          , {clientWidth: t, clientHeight: r} = i
                          , s = e[0] / e[1];
                        t / r > s ? ((0,
                        o.setStyle)(a, "width", `${s * r}px`),
                        (0,
                        o.setStyle)(a, "height", "100%"),
                        (0,
                        o.setStyle)(a, "margin", "0 auto")) : ((0,
                        o.setStyle)(a, "width", "100%"),
                        (0,
                        o.setStyle)(a, "height", `${t / s}px`),
                        (0,
                        o.setStyle)(a, "margin", "auto 0")),
                        i.dataset.aspectRatio = n
                    }
                    r.show = `${t.get("Aspect Ratio")}: ${"default" === n ? t.get("Default") : n}`,
    ...
    "36kPY": [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {notice: t, template: {$video: r}} = e
              , a = (0,
            ...
            let {i18n: t, notice: r, template: {$video: a, $player: o}} = e
              , s = e => {
                ...
                i.default).on("change", () => {
                    ...
                    i.default.isFullscreen ? (e.state = "fullscreen",
                    (0,
                    n.addClass)(o, "art-fullscreen")) : (0,
                    n.removeClass)(o, "art-fullscreen"),
                    e.emit("resize")
                }
                ),
                (0,
                i.default).on("error", t => {
              ...
              , l = e => {
                e.proxy(document, "webkitfullscreenchange", () => {
                    e.emit("fullscreen", e.fullscreen),
                    e.emit("resize")
                }
                ),
                (0,
                n.def)(e, "fullscreen", {
                    ...
                    set(t) {
                        t ? (e.state = "fullscreen",
                        a.webkitEnterFullscreen()) : a.webkitExitFullscreen()
                    }
                })
            }
            ;
            e.once("video:loadedmetadata", () => {
                i.default.isEnabled ? s(e) : a.webkitSupportsFullscreen ? l(e) : (0,
                n.def)(e, "fullscreen", {
                    get: () => !1,
                    set() {
    ...
    "5aYAP": [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {constructor: t, template: {$container: r, $player: a}} = e
              , i = "";
            (0,
            o.def)(e, "fullscreenWeb", {
                get: () => (0,
                o.hasClass)(a, "art-fullscreen-web"),
                set(n) {
                    n ? (i = a.style.cssText,
                    t.FULLSCREEN_WEB_IN_BODY && (0,
                    o.append)(document.body, a),
                    ...
                    o.setStyle)(a, "height", "100%"),
                    (0,
                    o.addClass)(a, "art-fullscreen-web"),
                    e.emit("fullscreenWeb", !0)) : (t.FULLSCREEN_WEB_IN_BODY && (0,
                    o.append)(r, a),
                    i && (a.style.cssText = i,
                    i = ""),
                    (0,
                    o.removeClass)(a, "art-fullscreen-web"),
    ...
    i1LDY: [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "autoSize", {
                value() {
                    let {videoWidth: i, videoHeight: n} = a
                      , {width: s, height: l} = (0,
                    o.getRect)(t)
                      , c = i / n;
                    s / l > c ? ((0,
                    o.setStyle)(r, "width", `${l * c / s * 100}%`),
                    (0,
                    o.setStyle)(r, "height", "100%")) : ((0,
                    o.setStyle)(r, "width", "100%"),
                    (0,
                    o.setStyle)(r, "height", `${s / c / l * 100}%`)),
                    e.emit("autoSize", {
                        width: e.width,
                        height: e.height
                    })
    ...
    "7E7Vs": [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "flip", {
                ...
                set(i) {
                    i || (i = "normal"),
                    "normal" === i ? delete t.dataset.flip : t.dataset.flip = i,
                    a.show = `${r.get("Video Flip")}: ${r.get((0,
                    o.capitalize)(i))}`,
                    e.emit("flip", i)
                }
            })
    ...
    gpugx: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {icons: t, proxy: r, storage: a, template: {$player: i, $video: n}} = e
              , s = !1
              , l = 0
              , c = 0;
            function p() {
                ...
                t && ((0,
                o.removeClass)(i, "art-mini"),
                (0,
                o.setStyle)(t, "display", "none"),
                i.prepend(n),
                e.emit("mini", !1))
            }
            function u(t, r) {
                ...
                o.setStyle)(t, "display", "none"),
                (0,
                o.setStyle)(r, "display", "flex")) : ((0,
                o.setStyle)(t, "display", "flex"),
                (0,
                o.setStyle)(r, "display", "none"))
            }
            function d() {
                let {$mini: t} = e.template
                  , r = (0,
                o.getRect)(t)
                  , i = window.innerHeight - r.height - 50
                  , n = window.innerWidth - r.width - 50;
                a.set("top", i),
                a.set("left", n),
                (0,
                o.setStyle)(t, "top", `${i}px`),
                (0,
                o.setStyle)(t, "left", `${n}px`)
            }
            (0,
            o.def)(e, "mini", {
                get: () => (0,
                o.hasClass)(i, "art-mini"),
                set(f) {
                    if (f) {
                        e.state = "mini",
                        (0,
                        o.addClass)(i, "art-mini");
                        let f = function() {
                            let {$mini: i} = e.template;
                            if (i)
                                return (0,
                                o.append)(i, n),
                                (0,
                                o.setStyle)(i, "display", "flex");
                            {
                                let i = (0,
                                o.createElement)("div");
                                (0,
                                o.addClass)(i, "art-mini-popup"),
                                (0,
                                o.append)(document.body, i),
                                e.template.$mini = i,
                                (0,
                                o.append)(i, n);
                                let d = (0,
                                o.append)(i, '<div class="art-mini-close"></div>');
                                (0,
                                o.append)(d, t.close),
                                r(d, "click", p);
                                let f = (0,
                                o.append)(i, '<div class="art-mini-state"></div>')
                                  , h = (0,
                                o.append)(f, t.play)
                                  , m = (0,
                                o.append)(f, t.pause);
                                return r(h, "click", () => e.play()),
                                r(m, "click", () => e.pause()),
                                u(h, m),
                                ...
                                e.on("document:mousemove", e => {
                                    if (s) {
                                        (0,
                                        o.addClass)(i, "art-mini-droging");
                                        let t = e.pageX - l
                                          , r = e.pageY - c;
                                        (0,
                                        o.setStyle)(i, "transform", `translate(${t}px, ${r}px)`)
                                    }
                                }
                                ),
                                e.on("document:mouseup", () => {
                                    if (s) {
                                        s = !1,
                                        (0,
                                        o.removeClass)(i, "art-mini-droging");
                                        let e = (0,
                                        o.getRect)(i);
                                        a.set("left", e.left),
                                        a.set("top", e.top),
                                        (0,
                                        o.setStyle)(i, "left", `${e.left}px`),
                                        (0,
                                        o.setStyle)(i, "top", `${e.top}px`),
                                        (0,
                          ...
                          , m = a.get("left");
                        h && m ? ((0,
                        o.setStyle)(f, "top", `${h}px`),
                        (0,
                        o.setStyle)(f, "left", `${m}px`),
                        (0,
                        o.isInViewport)(f) || d()) : d(),
                        e.emit("mini", !0)
                    } else
                        p()
                }
    ...
    "1SuFS": [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "poster", {
                ...
                set(e) {
                    (0,
                    o.setStyle)(t, "backgroundImage", `url(${e})`)
                }
            })
        }
    }
    ...
    "8x4te": [function(e, t, r) {
        ...
        function i(e) {
            ...
            o.def)(e, "autoHeight", {
                value() {
                    let {clientWidth: a} = t
                      , {videoHeight: i, videoWidth: n} = r
                      , s = a / n * i;
                    (0,
                    o.setStyle)(t, "height", s + "px"),
                    e.emit("autoHeight", s)
                }
            })
        }
            ...
            o.def)(e, "subtitleOffset", {
                ...
                set(i) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                        ...
                        r.startTime = (0,
                        o.clamp)(r.originalStartTime + s, 0, e.duration),
                        r.endTime = (0,
                        o.clamp)(r.originalEndTime + s, 0, e.duration)
                    }
                    e.subtitle.update(),
                    t.show = `${r.get("Subtitle Offset")}: ${i}s`,
                    e.emit("subtitleOffset", i)
                }
            })
        }
    }
    ...
    eftqT: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {i18n: t, notice: r, proxy: a, template: {$video: i}} = e
              , n = !0;
            ...
            o.def)(e, "airplay", {
                value() {
                    n ? (i.webkitShowPlaybackTargetPicker(),
            ...
            o.def)(e, "quality", {
                set(t) {
                    ...
                    r.update({
                        ...
                        html: i?.html || "",
                        selector: t,
                        onSelect: async t => (await e.switchQuality(t.url),
    ...
    "4HcqV": [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {events: t, option: r, template: {$progress: a, $video: i}} = e
              , n = null
              , s = null
              , l = !1
              , c = !1
            ...
            e.on("setBar", async (t, u, d) => {
                ...
                if ("hover" === t || g) {
                    ...
                    (0,
                    o.setStyle)(f, "display", "flex"),
                    t > 0 && t < a.clientWidth ? function(t) {
                        let n = e.controls?.thumbnails;
                        if (!n)
                            return;
                        let {number: l, column: c, width: p, height: u, scale: d} = r.thumbnails
                          , f = p * d || s.naturalWidth / c
                          , h = u * d || f / (i.videoWidth / i.videoHeight)
                          , m = Math.floor(t / (a.clientWidth / l))
                          , g = Math.ceil(m / c) - 1;
                        (0,
                        o.setStyle)(n, "backgroundImage", `url(${s.src})`),
                        (0,
                        o.setStyle)(n, "height", `${h}px`),
                        (0,
                        o.setStyle)(n, "width", `${f}px`),
                        (0,
                        o.setStyle)(n, "backgroundPosition", `-${(m % c || c - 1) * f}px -${g * h}px`),
                        t <= f / 2 ? (0,
                        o.setStyle)(n, "left", 0) : t > a.clientWidth - f / 2 ? (0,
                        o.setStyle)(n, "left", `${a.clientWidth - f}px`) : (0,
                        o.setStyle)(n, "left", `${t - f / 2}px`)
                    }(t) : o.isMobile || (0,
                    o.setStyle)(f, "display", "none"),
                    g && (clearTimeout(n),
                    n = setTimeout( () => {
                        (0,
                        o.setStyle)(f, "display", "none")
            ...
            o.def)(e, "thumbnails", {
                ...
                set(t) {
                    t.url && !e.option.isLive && (e.option.thumbnails = t,
                    clearTimeout(n),
                    n = null,
                    s = null,
                    l = !1,
    ...
    fCWZK: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {option: t, storage: r, template: {$video: a, $poster: i}} = e;
            for (let r in t.moreVideoAttr)
                e.attr(r, t.moreVideoAttr[r]);
            t.muted && (e.muted = t.muted),
            t.volume && (a.volume = (0,
            o.clamp)(t.volume, 0, 1));
            let n = r.get("volume");
            for (let r in "number" == typeof n && (a.volume = (0,
            o.clamp)(n, 0, 1)),
            t.poster && (0,
            o.setStyle)(i, "backgroundImage", `url(${t.poster})`),
            t.autoplay && (a.autoplay = t.autoplay),
            t.playsInline && (a.playsInline = !0,
            a["webkit-playsinline"] = !0),
    ...
    f8Lv3: [function(e, t, r) {
        ...
        var o = e("../config")
          ...
          , n = e("../utils");
        function s(e) {
            let {i18n: t, notice: r, option: a, constructor: o, proxy: s, template: {$player: l, $video: c, $poster: p}} = e
              , u = 0;
            for (let t = 0; t < i.default.events.length; t++)
                s(c, i.default.events[t], t => {
            ...
            e.on("video:error", async i => {
                u < o.RECONNECT_TIME_MAX ? (await (0,
                n.sleep)(o.RECONNECT_SLEEP_TIME),
                u += 1,
                e.url = a.url,
                r.show = `${t.get("Reconnect")}: ${u}`,
                e.emit("error", i, u)) : (e.mask.show = !0,
                e.loading.show = !1,
                e.controls.show = !0,
                (0,
    ...
    "8Z0Uf": [function(e, t, r) {
        ...
        class T extends i.default {
            constructor(e) {
                ...
                e.on("control", e => {
                    e ? ((0,
                    I.removeClass)(r, "art-hide-cursor"),
                    (0,
                    I.addClass)(r, "art-hover"),
                    this.timer = Date.now()) : ((0,
                    I.addClass)(r, "art-hide-cursor"),
                    (0,
                    I.removeClass)(r, "art-hover"))
                }
                ),
                this.init()
            }
            ...
            add(e) {
                let t = "function" == typeof e ? e(this.art) : e
                  , {$progress: r, $controlsLeft: a, $controlsRight: o} = this.art.template;
                switch (t.position) {
                case "top":
                    this.$parent = r;
                    break;
            ...
            check(e) {
                ...
                for (let t = 0; t < e.$control_option.length; t++) {
                    ...
                    r.default = r === e,
                    r.default && (0,
                    I.inverseClass)(r.$control_item, "art-current")
                }
            }
            selector(e, t, r) {
                ...
                I.createElement)("div");
                (0,
                I.addClass)(o, "art-selector-value"),
                (0,
                I.append)(o, e.html),
                t.innerText = "",
                (0,
                ...
                I.createElement)("div");
                (0,
                I.addClass)(i, "art-selector-list"),
                (0,
                I.append)(t, i);
                for (let t = 0; t < e.selector.length; t++) {
                    ...
                    I.createElement)("div");
                    (0,
                    I.addClass)(a, "art-selector-item"),
                    r.default && (0,
                    I.addClass)(a, "art-current"),
                    a.dataset.index = t,
                    ...
                    I.append)(i, a),
                    (0,
                    I.def)(r, "$control_option", {
                        get: () => e.selector
                    }),
                    (0,
                    I.def)(r, "$control_item", {
                        get: () => a
                    }),
                    (0,
                    I.def)(r, "$control_value", {
                        get: () => o
                    })
                }
                let n = a(i, "click", async t => {
                    ...
                    this.check(a),
                    e.onSelect && (o.innerHTML = await e.onSelect.call(this.art, a, a.$control_item, t))
                }
                );
                r.push(n)
            }
    ...
    "18nVI": [function(e, t, r) {
        ...
        r.default = class {
            ...
            add(e) {
                ...
                p ? p.insertAdjacentElement("beforebegin", n) : (0,
                o.append)(this.$parent, n),
                t.html && (0,
                o.append)(n, t.html),
                t.style && (0,
                o.setStyles)(n, t.style),
                t.tooltip && (0,
                o.tooltip)(n, t.tooltip);
                let u = [];
                if (t.click) {
                ...
                return t.selector && ["left", "right"].includes(t.position) && this.selector(t, n, u),
                this[r] = n,
                this.cache.set(r, {
                    $ref: n,
                    events: u,
            ...
            remove(e) {
                ...
                (0,
                i.errorHandle)(t, `Can't find [${e}] from the [${this.name}]`),
                t.option.beforeUnmount && t.option.beforeUnmount.call(this.art, t.$ref);
            ...
            update(e) {
                ...
                return t && (e = Object.assign(t.option, e),
                this.remove(e.name)),
                this.add(e)
            }
        }
    ...
    c61Lj: [function(e, t, r) {
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    let {proxy: r, icons: a, i18n: i} = t
                      , n = (0,
                    o.append)(e, a.fullscreenOn)
                      , s = (0,
                    o.append)(e, a.fullscreenOff);
                    (0,
                    ...
                    t.on("fullscreen", t => {
                        t ? ((0,
                        o.tooltip)(e, i.get("Exit Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "none"),
                        (0,
                        o.setStyle)(s, "display", "inline-flex")) : ((0,
                        o.tooltip)(e, i.get("Fullscreen")),
                        (0,
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    let {proxy: r, icons: a, i18n: i} = t
                      , n = (0,
                    o.append)(e, a.fullscreenWebOn)
                      , s = (0,
                    o.append)(e, a.fullscreenWebOff);
                    (0,
                    o.setStyle)(s, "display", "none"),
                    r(e, "click", () => {
                    ...
                    t.on("fullscreenWeb", t => {
                        t ? ((0,
                        o.tooltip)(e, i.get("Exit Web Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "none"),
                        (0,
                        o.setStyle)(s, "display", "inline-flex")) : ((0,
                        o.tooltip)(e, i.get("Web Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "inline-flex"),
                        (0,
                        o.setStyle)(s, "display", "none"))
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    ...
                    t.on("pip", t => {
                        (0,
                        o.tooltip)(e, i.get(t ? "Exit PIP Mode" : "PIP Mode"))
                    }
                    )
                }
            })
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    ...
                    (0,
                    o.tooltip)(n, i.get("Play")),
                    (0,
                    o.tooltip)(s, i.get("Pause")),
                    r(n, "click", () => {
                        t.play()
                    }
                    ),
    ...
    bgoVP: [function(e, t, r) {
        var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
        a.defineInteropFlag(r),
        a.export(r, "getPosFromEvent", () => i),
        a.export(r, "setCurrentTime", () => n),
        a.export(r, "default", () => s);
        var o = e("../utils");
        function i(e, t) {
            let {$progress: r} = e.template
              , {left: a} = (0,
            o.getRect)(r)
              , i = o.isMobile ? t.touches[0].clientX : t.clientX
              , n = (0,
            o.clamp)(i - a, 0, r.clientWidth)
              , s = n / r.clientWidth * e.duration
              , l = (0,
            o.secondToTime)(s)
              , c = (0,
            o.clamp)(n / r.clientWidth, 0, 1);
            return {
                second: s,
                time: l,
                width: n,
        ...
        function n(e, t) {
            if (e.isRotate) {
                let r = t.touches[0].clientY / e.height
                  , a = r * e.duration;
                e.emit("setBar", "played", r, t),
                e.seek = a
            } else {
                let {second: r, percentage: a} = i(e, t);
                e.emit("setBar", "played", a, t),
                e.seek = r
            }
        }
        function s(e) {
                ...
                return {
                    ...
                    mounted: e => {
                        let l = null
                          , c = !1
                          , p = (0,
                        o.query)(".art-progress-hover", e)
                          , u = (0,
                        o.query)(".art-progress-loaded", e)
                          , d = (0,
                        o.query)(".art-progress-played", e)
                          , f = (0,
                        o.query)(".art-progress-highlight", e)
                          , h = (0,
                        o.query)(".art-progress-indicator", e)
                          , m = (0,
                        o.query)(".art-progress-tip", e);
                        function g(r, a) {
                            let {width: n, time: s} = a || i(t, r);
                            m.innerText = s;
                            let l = m.clientWidth;
                            n <= l / 2 ? (0,
                            o.setStyle)(m, "left", 0) : n > e.clientWidth - l / 2 ? (0,
                            o.setStyle)(m, "left", `${e.clientWidth - l}px`) : (0,
                            o.setStyle)(m, "left", `${n - l / 2}px`)
                        }
                        r.indicator ? (0,
                        o.append)(h, r.indicator) : (0,
                        o.setStyle)(h, "backgroundColor", "var(--art-theme)"),
                        t.on("setBar", function(r, a, i) {
                            let n = "played" === r && i && o.isMobile;
                            "loaded" === r && (0,
                            o.setStyle)(u, "width", `${100 * a}%`),
                            "hover" === r && (0,
                            o.setStyle)(p, "width", `${100 * a}%`),
                            "played" === r && ((0,
                            o.setStyle)(d, "width", `${100 * a}%`),
                            (0,
                            o.setStyle)(h, "left", `${100 * a}%`)),
                            n && ((0,
                            o.setStyle)(m, "display", "flex"),
                            g(i, {
                                width: e.clientWidth * a,
                                time: (0,
                                o.secondToTime)(a * t.duration)
                            }),
                            clearTimeout(l),
                            l = setTimeout( () => {
                                (0,
                                o.setStyle)(m, "display", "none")
                            }
                            , 500))
                        }),
                        t.on("video:loadedmetadata", function() {
                            ...
                            for (let e = 0; e < a.highlight.length; e++) {
                                let r = a.highlight[e]
                                  , i = (0,
                                o.clamp)(r.time, 0, t.duration) / t.duration * 100
                        ...
                        s(e, "mousemove", r => {
                            let {percentage: a} = i(t, r);
                            t.emit("setBar", "hover", a, r),
                            (0,
                            o.setStyle)(m, "display", "flex"),
                            (0,
                            o.includeFromEvent)(r, f) ? function(r) {
                                let {width: a} = i(t, r)
                                  , {text: n} = r.target.dataset;
                                m.innerText = n;
                                let s = m.clientWidth;
                                a <= s / 2 ? (0,
                                o.setStyle)(m, "left", 0) : a > e.clientWidth - s / 2 ? (0,
                                o.setStyle)(m, "left", `${e.clientWidth - s}px`) : (0,
                                o.setStyle)(m, "left", `${a - s / 2}px`)
                            }(r) : g(r)
                        }
                        ),
                        s(e, "mouseleave", e => {
                        ...
                        t.on("document:mousemove", e => {
                            if (c) {
                                let {second: r, percentage: a} = i(t, e);
                                t.emit("setBar", "played", a, e),
                                t.seek = r
                            }
                        }
                        ),
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    ...
                    o.append)(e, a.volume)
                      , n = (0,
                    o.append)(e, a.volumeClose)
                      , s = (0,
                    o.append)(e, '<div class="art-volume-panel"></div>')
                      , l = (0,
                    o.append)(s, '<div class="art-volume-inner"></div>')
                      , c = (0,
                    o.append)(l, '<div class="art-volume-val"></div>')
                      , p = (0,
                    o.append)(l, '<div class="art-volume-slider"></div>')
                      , u = (0,
                    o.append)(p, '<div class="art-volume-handle"></div>')
                      , d = (0,
                    o.append)(u, '<div class="art-volume-loaded"></div>')
                      , f = (0,
                    o.append)(p, '<div class="art-volume-indicator"></div>');
                    function h(e) {
                        let {top: t, height: r} = (0,
                        o.getRect)(p);
                    ...
                    function m() {
                        if (t.muted || 0 === t.volume)
                            ...
                            o.setStyle)(n, "display", "flex"),
                            (0,
                            o.setStyle)(f, "top", "100%"),
                            (0,
                            o.setStyle)(d, "top", "100%"),
                            c.innerText = 0;
                        else {
                            let e = 100 * t.volume;
                            (0,
                            ...
                            o.setStyle)(n, "display", "none"),
                            (0,
                            o.setStyle)(f, "top", `${100 - e}%`),
                            (0,
                            o.setStyle)(d, "top", `${100 - e}%`),
        ...
        function i(e) {
            return t => ({
                ...
                mounted: e => {
                    ...
                    t.on("setting", t => {
                        (0,
                        o.tooltip)(e, i.get(t ? "Hide Setting" : "Show Setting"))
                    }
                    )
                }
            })
        ...
        class b extends n.default {
            ...
            init() {
                ...
                t(r, "contextmenu", e => {
                    ...
                    let t = e.clientX
                      , i = e.clientY
                      , {height: n, width: s, left: l, top: c} = (0,
                    o.getRect)(r)
                      , {height: p, width: u} = (0,
                    o.getRect)(a)
                      , d = t - l
                ...
                t(r, "click", e => {
                    (0,
                    o.includeFromEvent)(e, a) || (this.show = !1)
                }
                ),
                this.art.on("blur", () => {
                    this.show = !1
        ...
        function i(e) {
            return t => {
                let {i18n: r, constructor: {PLAYBACK_RATE: a}} = t
                  , i = a.map(e => `<span data-value="${e}">${1 === e ? r.get("Normal") : e.toFixed(1)}</span>`).join("");
                return {
                    ...e,
                    html: `${r.get("Play Speed")}: ${i}`,
                    click: (e, r) => {
                        let {value: a} = r.target.dataset;
                        a && (t.playbackRate = Number(a),
                        e.show = !1)
                    }
                    ,
                    mounted: e => {
                        let r = (0,
                        o.query)('[data-value="1"]', e);
                        r && (0,
                        o.inverseClass)(r, "art-current"),
                        t.on("video:ratechange", () => {
                            let r = (0,
                            o.queryAll)("span", e).find(e => Number(e.dataset.value) === t.playbackRate);
                            r && (0,
                            o.inverseClass)(r, "art-current")
                        }
                        )
        ...
        function i(e) {
            return t => {
                let {i18n: r, constructor: {ASPECT_RATIO: a}} = t
                  , i = a.map(e => `<span data-value="${e}">${"default" === e ? r.get("Default") : e}</span>`).join("");
                return {
                    ...e,
        ...
        function i(e) {
            return t => {
                let {i18n: r, constructor: {FLIP: a}} = t
                  , i = a.map(e => `<span data-value="${e}">${r.get((0,
                o.capitalize)(e))}</span>`).join("");
                return {
                    ...e,
                    html: `${r.get("Video Flip")}: ${i}`,
                    click: (e, r) => {
                        let {value: a} = r.target.dataset;
                        a && (t.flip = a.toLowerCase(),
                        e.show = !1)
                    }
                    ,
                    mounted: e => {
                        let r = (0,
                        o.query)('[data-value="normal"]', e);
                        r && (0,
                        o.inverseClass)(r, "art-current"),
                        t.on("flip", t => {
                            let r = (0,
    ...
    "02ajl": [function(e, t, r) {
        ...
        class s extends n.default {
            ...
            init() {
                let {proxy: e, constructor: t, template: {$infoPanel: r, $infoClose: a, $video: i}} = this.art;
                e(a, "click", () => {
                    this.show = !1
                }
                );
    ...
    eSWto: [function(e, t, r) {
        ...
        class u extends n.default {
            ...
            update() {
                let {option: {subtitle: e}, template: {$subtitle: t}} = this.art;
                t.innerHTML = "",
                this.activeCues.length && (this.art.emit("subtitleBeforeUpdate", this.activeCues),
                t.innerHTML = this.activeCues.map( (t, r) => t.text.split(/\r?\n/).filter(e => e.trim()).map(t => `<div class="art-subtitle-line" data-group="${r}">${e.escape ? (0,
                o.escape)(t) : t}</div>`).join("")).join(""),
            ...
            async switch(e, t={}) {
                let {i18n: r, notice: a, option: o} = this.art
                  ...
                  , n = await this.init(i);
                return t.name && (a.show = `${r.get("Switch Subtitle")}: ${t.name}`),
                n
            }
            createTrack(e, t) {
                let {template: r, proxy: a, option: i} = this.art
                  , {$video: n, $track: s} = r
                  , l = (0,
                ...
                l.kind = e,
                l.src = t,
                l.label = i.subtitle.name || "Artplayer",
                l.track.mode = "hidden",
                l.onload = () => {
                ...
                o.append)(n, l),
                r.$track = l,
                this.destroyEvent = a(this.textTrack, "cuechange", () => this.update())
            }
            async init(e) {
    ...
    "6UrCm": [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e, t) {
            let {constructor: r, template: {$player: a, $video: i}} = e;
            t.proxy(document, ["click", "contextmenu"], t => {
                (0,
                o.includeFromEvent)(t, a) ? (e.isInput = "INPUT" === t.target.tagName,
                e.isFocus = !0,
                e.emit("focus", t)) : (e.isInput = !1,
                e.isFocus = !1,
                e.emit("blur", t))
            }
            );
            ...
            t.proxy(i, "click", t => {
                let a = Date.now();
                n.push(a);
                let {MOBILE_CLICK_PLAY: i, DBCLICK_TIME: s, MOBILE_DBCLICK_PLAY: l, DBCLICK_FULLSCREEN: c} = r
                  , p = n.filter(e => a - e <= s);
                switch (p.length) {
                case 1:
                    e.emit("click", t),
                    o.isMobile ? !e.isLock && i && e.toggle() : e.toggle(),
                    n = p;
                    break;
                case 2:
                    e.emit("dblclick", t),
                    o.isMobile ? !e.isLock && l && e.toggle() : c && (e.fullscreen = !e.fullscreen),
                    n = [];
                    break;
                default:
                    n = []
    ...
    eDXPO: [function(e, t, r) {
        ...
        function i(e, t) {
            ...
            let i = (0,
            o.debounce)( () => e.emit("resize"), a.RESIZE_TIME);
            t.proxy(window, ["orientationchange", "resize"], () => i()),
            screen && screen.orientation && screen.orientation.onchange && t.proxy(screen.orientation, "change", () => i())
        }
    }
    , {
        "../utils": "71aH7",
                ...
                let {$video: r, $progress: a} = e.template
                  ...
                  , u = t => {
                    if (1 === t.touches.length && !e.isLock) {
                        ...
                        s = !0;
                        let {pageX: r, pageY: o} = t.touches[0];
                        l = r,
                        c = o,
                        p = e.currentTime
                    }
                  ...
                  , d = t => {
                    if (1 === t.touches.length && s && e.duration) {
                        let {pageX: a, pageY: i} = t.touches[0]
                          , s = function(e, t, r, a) {
                            var o = t - a
                              , i = r - e
                              , n = 0;
                            if (2 > Math.abs(i) && 2 > Math.abs(o))
                                return n;
                            var s = 180 * Math.atan2(o, i) / Math.PI;
                            return s >= -45 && s < 45 ? n = 4 : s >= 45 && s < 135 ? n = 1 : s >= -135 && s < -45 ? n = 2 : (s >= 135 && s <= 180 || s >= -180 && s < -135) && (n = 3),
                            n
                        }(l, c, a, i)
                          , u = [3, 4].includes(s)
                          , d = [1, 2].includes(s);
                        if (u && !e.isRotate || d && e.isRotate) {
                            let s = (0,
                            o.clamp)((a - l) / e.width, -1, 1)
                              , u = (0,
                            o.clamp)((i - c) / e.height, -1, 1)
                              , d = e.isRotate ? u : s
    ...
    InUBx: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e, t) {
            let {option: r, constructor: a, template: {$container: i}} = e
              , n = (0,
            o.throttle)( () => {
                e.emit("view", (0,
                o.isInViewport)(i, a.SCROLL_GAP))
            }
            , a.SCROLL_TIME);
    ...
    "3dsEe": [function(e, t, r) {
        ...
        class s extends n.default {
            constructor(e) {
                ...
                this.name = "loading",
                (0,
                o.append)(e.template.$loading, e.icons.loading)
            }
        }
        r.default = s
    }
    ...
    dWGTw: [function(e, t, r) {
        ...
        r.default = class {
            ...
            set show(e) {
                let {constructor: t, template: {$player: r, $noticeInner: o}} = this.art;
                e ? (o.innerText = e instanceof Error ? e.message.trim() : e,
                (0,
        ...
        class s extends n.default {
            constructor(e) {
                ...
                let {template: t, icons: r, events: a} = e
                  , i = (0,
                o.append)(t.$state, r.state)
                  , n = (0,
                o.append)(t.$state, r.error);
                (0,
                o.setStyle)(n, "display", "none"),
                e.on("destroy", () => {
                    (0,
    ...
    "3eYNH": [function(e, t, r) {
        ...
        class m extends f.default {
            constructor(e) {
                ...
                e.on("focus", e => {
                    let t = (0,
                    h.includeFromEvent)(e, r.setting)
                      , a = (0,
                    h.includeFromEvent)(e, this.$parent);
                    !this.show || t || a || (this.show = !1,
                    this.render())
                }
                ),
            ...
            get builtin() {
                let e = []
                  , {option: t} = this.art;
                return t.playbackRate && e.push((0,
                c.default)(this.art)),
                t.aspectRatio && e.push((0,
                s.default)(this.art)),
                t.flip && e.push((0,
                i.default)(this.art)),
                t.subtitleOffset && e.push((0,
                u.default)(this.art)),
                e
            }
            ...
            check(e) {
                ...
                this.traverse(t => {
                    t.default = t === e,
                    t.default && t.$item && (0,
                    h.inverseClass)(t.$item, "art-current")
                }
                , e.$option),
            ...
            format(e=this.option, t, r, a=[]) {
                for (let o = 0; o < e.length; o++) {
                    let i = e[o];
                    if (i?.name ? ((0,
                    h.errorHandle)(!a.includes(i.name), `The [${i.name}] is already exist in [setting]`),
                    a.push(i.name)) : i.name = `setting-${this.id++}`,
                    !i.$formatted) {
                        (0,
                        h.def)(i, "$parent", {
                            get: () => t
            ...
            resize() {
                let {controls: e, constructor: {SETTING_WIDTH: t, SETTING_ITEM_HEIGHT: r}, template: {$player: a, $setting: o}} = this.art;
                if (e.setting && this.show) {
                    ...
                    if ((0,
                    h.setStyle)(o, "height", `${u}px`),
                    (0,
                    h.setStyle)(o, "width", `${i}px`),
                    this.art.isRotate || h.isMobile)
                        return;
                    p + i > c ? ((0,
                    h.setStyle)(o, "left", null),
                    (0,
                    h.setStyle)(o, "right", null)) : ((0,
                    h.setStyle)(o, "left", `${p}px`),
                    (0,
                    h.setStyle)(o, "right", "auto"))
                }
            }
            inactivate(e) {
            ...
            remove(e) {
                let t = this.find(e);
                (0,
                h.errorHandle)(t, `Can't find [${e}] in the [setting]`);
            ...
            creatHeader(e) {
                if (!this.cache.has(e.$option))
                    return;
                let t = this.cache.get(e.$option)
                  , {proxy: r, icons: {arrowLeft: a}, constructor: {SETTING_ITEM_HEIGHT: o}} = this.art
                  , i = (0,
                h.createElement)("div");
                (0,
                h.setStyle)(i, "height", `${o}px`),
                (0,
                h.addClass)(i, "art-setting-item"),
                (0,
                h.addClass)(i, "art-setting-item-back");
                let n = (0,
                ...
                h.append)(n, s),
                (0,
                h.append)(n, e.$parent.html);
                let l = r(i, "click", () => this.render(e.$parents));
                e.$parent.$events.push(l),
                (0,
                h.append)(t, i)
            }
            creatItem(e, t=!1) {
                ...
                let r = this.cache.get(e.$option)
                  ...
                  , o = "selector";
                (0,
                h.has)(e, "switch") && (o = "switch"),
                (0,
                h.has)(e, "range") && (o = "range");
                let {icons: i, proxy: n, constructor: s} = this.art
                  , l = (0,
                h.createElement)("div");
                (0,
                h.addClass)(l, "art-setting-item"),
                (0,
                h.setStyle)(l, "height", `${s.SETTING_ITEM_HEIGHT}px`),
                l.dataset.name = e.name || "",
                l.dataset.value = e.value || "";
                let c = (0,
                h.append)(l, '<div class="art-setting-item-left"></div>')
                  , p = (0,
                h.append)(l, '<div class="art-setting-item-right"></div>')
                  , u = (0,
                h.createElement)("div");
                switch ((0,
                h.addClass)(u, "art-setting-item-left-icon"),
                o) {
                case "switch":
                case "range":
                    (0,
                    h.append)(u, e.icon || i.config);
                    break;
                case "selector":
                    e.selector?.length ? (0,
                    h.append)(u, e.icon || i.config) : (0,
                    h.append)(u, i.check)
                }
                (0,
                h.append)(c, u),
                ...
                h.createElement)("div");
                (0,
                h.addClass)(d, "art-setting-item-left-text"),
                (0,
                h.append)(d, e.html || ""),
                (0,
                h.append)(c, d),
                ...
                h.createElement)("div");
                switch ((0,
                h.addClass)(f, "art-setting-item-right-tooltip"),
                (0,
                h.append)(f, e.tooltip || ""),
                (0,
                h.append)(p, f),
                (0,
                h.def)(e, "$tooltip", {
                ...
                case "switch":
                    {
                        ...
                        h.createElement)("div");
                        (0,
                        h.addClass)(t, "art-setting-item-right-icon");
                        let r = (0,
                        h.append)(t, i.switchOn)
                          , a = (0,
                        h.append)(t, i.switchOff);
                        (0,
                        h.setStyle)(e.switch ? a : r, "display", "none"),
                        (0,
                        h.append)(p, t),
                        (0,
                        h.def)(e, "$switch", {
                        ...
                        h.def)(e, "switch", {
                            ...
                            set(e) {
                                ...
                                (0,
                                h.setStyle)(r, "display", null)) : ((0,
                                h.setStyle)(a, "display", null),
                                (0,
                ...
                case "selector":
                    {
                        let t = n(l, "click", async t => {
                            e.selector?.length ? this.render(e.selector) : (this.check(e),
                            e.$parent.onSelect && (e.$parent.tooltip = await e.$parent.onSelect.call(this.art, e, l, t)))
                        }
                        );
                        e.$events.push(t),
                        e.default && (0,
                        h.addClass)(l, "art-current")
                    }
                }
                (0,
                h.def)(e, "$item", {
                ...
                t ? (0,
                h.replaceElement)(l, a) : (0,
                h.append)(r, l),
                e.mounted && setTimeout( () => e.mounted.call(this.art, e.$item, e), 0)
            }
            render(e=this.option) {
                ...
                this.cache.has(e)) {
                    ...
                    this.cache.set(e, t),
                    (0,
                    h.addClass)(t, "art-setting-panel"),
                    (0,
                    h.append)(this.$parent, t),
                    (0,
                    h.inverseClass)(t, "art-current"),
                    e[0]?.$parent && this.creatHeader(e[0]);
    ...
    kONUB: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {i18n: t, icons: r, constructor: {SETTING_ITEM_WIDTH: a, FLIP: i}} = e;
            function n(e) {
                return t.get((0,
                o.capitalize)(e))
            }
    ...
    "84NBV": [function(e, t, r) {
        ...
        function o(e) {
            ...
            return {
                ...
                onSelect: t => (e.aspectRatio = t.value,
                t.html),
                mounted: () => {
                    n(),
                    e.on("aspectRatio", () => n())
    ...
    aetWt: [function(e, t, r) {
        ...
        function o(e) {
            ...
            return {
                ...
                onSelect: t => (e.playbackRate = t.value,
                t.html),
                mounted: () => {
                    n(),
                    e.on("video:ratechange", () => n())
                }
            }
        }
        a.defineInteropFlag(r),
    ...
    fIBkO: [function(e, t, r) {
        ...
        function o(e) {
            ...
            return {
                ...
                tooltip: "0s",
                range: [0, -10, 10, .1],
                onChange: t => (e.subtitleOffset = t.range[0],
                t.range[0] + "s"),
                mounted: (t, r) => {
    ...
    "87pSL": [function(e, t, r) {
        ...
        function i(e) {
            return e.on("control", t => {
                t ? (0,
                o.removeClass)(e.template.$player, "art-mini-progress-bar") : (0,
                o.addClass)(e.template.$player, "art-mini-progress-bar")
            }
            ),
            {
    ...
    ePEg5: [function(e, t, r) {
        ...
        function i(e) {
            ...
            return e.on("fullscreenWeb", i => {
                if (i) {
                    ...
                    (i > n && s < l || i < n && s > l) && setTimeout( () => {
                        (0,
                        o.setStyle)(r, "width", `${l}px`),
                        (0,
                        o.setStyle)(r, "height", `${s}px`),
                        (0,
                        o.setStyle)(r, "transform-origin", "0 0"),
                        (0,
                        o.setStyle)(r, "transform", `rotate(90deg) translate(0, -${s}px)`),
                        (0,
                        o.addClass)(r, "art-auto-orientation"),
                        e.isRotate = !0,
                        e.emit("resize")
                    }
                    ...
                    (0,
                    o.hasClass)(r, "art-auto-orientation") && ((0,
                    o.removeClass)(r, "art-auto-orientation"),
                    e.isRotate = !1,
                    e.emit("resize"))
            }
            ),
            e.on("fullscreen", async e => {
                ...
                if (e) {
                    let {videoWidth: e, videoHeight: i} = a
                    ...
                    if (e > i && n < s || e < i && n > s) {
                        ...
                        (0,
                        o.addClass)(r, "art-auto-orientation-fullscreen")
                    }
                } else
                    (0,
                    o.hasClass)(r, "art-auto-orientation-fullscreen") && (await screen.orientation.lock(t),
                    (0,
                    o.removeClass)(r, "art-auto-orientation-fullscreen"))
            }
            ),
            {
                ...
                get state() {
                    return (0,
                    o.hasClass)(r, "art-auto-orientation")
                }
            }
        }
    }
    ...
    cVO99: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {i18n: t, icons: r, storage: a, constructor: i, proxy: n, template: {$poster: s}} = e
              , l = e.layers.add({
                name: "auto-playback",
                html: `<div class="art-auto-playback-close"></div><div class="art-auto-playback-last"></div><div class="art-auto-playback-jump"></div>`
            })
              , c = (0,
            o.query)(".art-auto-playback-last", l)
              , p = (0,
            o.query)(".art-auto-playback-jump", l)
              , u = (0,
            o.query)(".art-auto-playback-close", l);
            (0,
            o.append)(u, r.close);
            let d = null;
            function f() {
            ...
            return e.on("video:timeupdate", () => {
                if (e.playing) {
                    let t = a.get("times") || {}
                      , r = Object.keys(t);
                    r.length > i.AUTO_PLAYBACK_MAX && delete t[r[0]],
    ...
    hFDwt: [function(e, t, r) {
        ...
        var o = e("../utils");
        function i(e) {
            let {constructor: t, proxy: r, template: {$player: a, $video: i}} = e
              , n = null
              , s = !1
              , l = 1
              , c = () => {
                ...
                e.playbackRate = l,
                (0,
                o.removeClass)(a, "art-fast-forward"))
            }
            ;
    ...
    "1hsTH": [function(e, t, r) {
        ...
        function i(e) {
            ...
            function i() {
                return (0,
                o.hasClass)(a, "art-lock")
            }
            function n() {
                (0,
                o.addClass)(a, "art-lock"),
                e.isLock = !0,
                e.emit("lock", !0)
            }
            function s() {
                (0,
                o.removeClass)(a, "art-lock"),
                e.isLock = !1,
                e.emit("lock", !1)
            }
            return t.add({
                ...
                mounted(t) {
                    ...
                    o.append)(t, r.unlock);
                    (0,
                    o.setStyle)(a, "display", "none"),
                    e.on("lock", e => {
                        e ? ((0,
                        o.setStyle)(a, "display", "inline-flex"),
                        (0,
                        o.setStyle)(i, "display", "none")) : ((0,
                        o.setStyle)(a, "display", "none"),
                        (0,
