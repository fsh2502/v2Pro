...
check(
    $announce === '👤 ID: 25 | 📱 Đã dùng: 1.5 GB | 💡 Hạn: 2027-01-01',
    'Default announce must contain user ID, used traffic and expiration date'
);
...
check(
    $unlimited === "👤 ID: 8 | 📱 Đã dùng: 0 GB | 💡 Hạn: Không thời hạn\nUnsupported nodes: 1",
